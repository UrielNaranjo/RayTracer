...
public:
    ...
    // indicates whether the ray is semi_infinite or should stop at t_max
    bool semi_infinite;  

    // maximum value of t allowed for the ray
    double t_max; 

    // used to store a pointer to the object of intersection
